...
public class DigestUserSchemaTest extends BaseTest {
  ...
  /**
   * On the databases without auto increment (and on hsqldb), the id declared
   * through PortableSequence is drawn from this sequence. A missing sequence
   * makes every enrollment fail at runtime while the table itself looks
   * perfectly fine.
   */
