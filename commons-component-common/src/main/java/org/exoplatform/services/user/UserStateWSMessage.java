...
@Data
public class UserStateWSMessage extends UserStateModel {

  private String wsEventName;

  public UserStateWSMessage(UserStateModel parent, String wsEventName) {
    this.setUserId(parent.getUserId());
    this.setStatus(parent.getStatus());
    this.setWsEventName(wsEventName);
  }
  @Override
